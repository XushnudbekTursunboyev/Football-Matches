...
class TableAdapterNew() : RecyclerView.Adapter<TableAdapterNew.Vh>() {
    ...
    inner class Vh(var itemview: TeamItemBinding) : RecyclerView.ViewHolder(itemview.root) {
        ...
        itemview.apply {
            ...
            tvFirstTeamDraw.text = d.all.draw.toString()
            tvFirstTeamLost.text = d.all.lose.toString()
            tvFirstTeamGa.text = d.all.goals.against.toString()
