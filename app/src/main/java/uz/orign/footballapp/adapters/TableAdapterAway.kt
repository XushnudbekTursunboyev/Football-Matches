...
class TableAdapterAway() : RecyclerView.Adapter<TableAdapterAway.Vh>() {
    ...
    inner class Vh(var itemview: TeamItemBinding) : RecyclerView.ViewHolder(itemview.root) {
        ...
        itemview.apply {
            ...
            tvFirstTeamDraw.text = d.away.draw.toString()
            tvFirstTeamLost.text = d.away.lose.toString()
            tvFirstTeamGa.text = d.away.goals.against.toString()
